...
describe('Tools tests', function() {
  ...
  it('should create convert a positive float to a m/exp DPT-9 and back', function() {
      var float1 = 1244.22;
      var test = tools.convertToDPT9(float1);
  ...
  it('should create convert a negative float to a m/exp DPT-9 and back', function() {
      var float1 = -12442.23;
      var test = tools.convertToDPT9(float1);
      var float2 = tools.convertFromDPT9(test[0], test[1]);
      assert.equal(float1, float2);  });
